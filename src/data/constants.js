import quaidlogo from '../images/Quaid-e-Azam.png';
import comsatlogo from '../images/comsat.jpg';
import echobeatpic from '../images/echobeats.jpeg';
...
export const Bio = {
  ...
  facebook: "https://www.facebook.com/anees.khan.898651",
};
...
export const education = [
  {
    id: 0,
    img: quaidlogo,
    school: "Quaid-e-Azam Group of Schools Zaida swabi",
  ...
  },
  {
    id: 1,
    img: quaidlogo,
    school: "Quaid-e-Azam Group of Collages swabi",
    date: "Aug 2019 - July 2021",
    grade: "92%",
    desc: "I completed my class 12 high school education at Quaid-e-Azam Collage.",
  },
  {
    id: 2,
    img: comsatlogo,
...
export const projects = [
  {
    ...
    description:
      "Echobeats is a sleek and responsive music web app built with HTML, CSS, and JavaScript, allowing users to play, pause, and navigate songs with an engaging and intuitive interface.",
    image:
      echobeatpic,
    tags: [
      "HTML",
    ...
    category: "web app",
    github: "https://github.com/Aneeskhan7/Echobeats",
  },
  {
    id: 1,
    title: "X Clone",
    date: "Jun 2025",
    description:
      "A responsive X (Twitter) clone styled with Tailwind CSS, featuring a clean UI, modern design components, and mobile-first responsiveness to deliver a smooth social media experience.",
    image:
      Xpic,
    tags: [
      "TAILWIND"
    ...
    category: "web app",
    github: "https://github.com/Aneeskhan7/xclone",
  },
  {
    id: 2,
    ...
    description:
      "PassOP is a modern, full-stack password manager built with the MERN stack, designed to keep your credentials safe and easily accessible. It features robust encryption, a clean and intuitive UI, and seamless CRUD functionality, empowering users to securely store, organize, and manage their passwords anytime, anywhere.",
    image:
      passOP,
    tags: ["React Js", "MongoDb", "Node Js", "Express Js", "Redux"],
    category: "web app",
    github: "https://github.com/Aneeskhan7/passop-password-manager"
  },
  {
    id: 3,
    title: "Job Portal",
    ...
    description:
      "Job Portal is a full-stack MERN application that connects job seekers with employers through an intuitive and responsive platform. It features user authentication, job posting and application management, real-time search and filtering, and a clean UI to ensure a smooth hiring and job-seeking experience.",
    image:
      JobPortal,
    tags: [
      "React Js",
